...
<template>
  <div class="approved">
    <div class="appcontent">
      ...
      <div class="app-list" v-for="(item, index) in arrlist" :key="index" @click="detail(item)">
        <div class="user">
          <div class="block">
        ...
        <div class="list-cont">
          <ul>
            <li>
              ...
              ><span :class="[item.state == '1' ? 'flag' : 'code']">{{ item.state[1] }}</span>
            </li>
            <li>
      ...
      <div class="content" v-if="show">
        ...
        <div class="app-box">
          ...
          <div class="app-argent">
            ...
            <div class="text">
              <p>审批建议：</p>
              <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="apply_comment">
              </el-input>
              <div class="app-btn">
                <el-button type="success" size="mini" @click="agree">同意</el-button>
...
export default {
  ...
  methods: {
    async swork() {
      await sworkflowtask(this.search, this.ordering, this.page, this.size).then((res) => {
