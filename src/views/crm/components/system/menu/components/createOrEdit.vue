...
<div class="createOrEdit">
    ...
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item label="父级菜单">       
        <el-cascader v-model="form.pid" :options="menus" :props="defaultProps" :show-all-levels="false" style="width: 460px;" placeholder="请选择父级菜单"></el-cascader>       
      </el-form-item>
    </el-form>
...
export default {
    ...
    methods:{
      ...
      resetForm() {
        ...
        this.form = { name: '', sort: 999, path: '', component: '', is_show: 'true', is_frame: 'false', pid: 0, icon: '' }
      }     
  }
}
</script>
