...
<div class="consumerList">
    ...
    <el-table-column label="操作" fixed="right" width="100">
      <template #default="scope">
        <el-button
          ...
          <el-button
          size="mini"
          @click="handleEditPassword(scope.row)">密码</el-button>
        <el-button
          size="mini"
          type="danger"
  ...
  <!-- <el-pagination
    ...
    <createOrEdit ref="form" :menus="userList" :roles="roles"  :organizations="organizations" :orgusers="orgusers" :is-add="false" :row-id="userId"/>
...
import { edit,del} from '../../../../../../api/user'
export default {
    name:"consumerList",
    components:{
        createOrEdit,password
    },
    props:{
        userList:[],
        roles:[],
