...
<div class="createOrEdit">
    <el-dialog center v-model="dialogVisible" :title="isAdd ? '新增用户' : '编辑用户'" width="850px">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="部门">
            ...
            <el-cascader v-model="form.department" :options="organizations" :props="defaultProps" clearable style="width: 300px;" placeholder="请选择部门"></el-cascader>
...
export default {
    ...
    methods:{
      ...
      resetForm() {
        ...
        this.roleIds = [];
        this.form = { username: '', name: '', mobile: '', department: [], superior: null, position: '', email: '', is_active: 'false', roles: [] }
      }
    }
}
</script>
