...
<div class="consumer">
    ...
    <consumerList :userList="userList" :roles="roles" :organizations="organizations" :orgusers="orgusers" :total="total" @initList="loadUsers"/>
    <createOrEdit ref="form" :menus="userList" :roles="roles" :organizations="organizations" :orgusers="orgusers" :is-add="true" :sup_this="sup_this"/>
</div>
</template>
