<template>
    <div class="roleList">
        <el-row :gutter="28">
            ...
            <el-col :span="8">
                <alloce-access ref="permissions" v-if="show" :roleList="roleList" :row_data="row_data" :permissionList="permissionList" :permissionIds="permissionIds"/>
                <!-- <alloceMenu v-if="show"/> -->
            </el-col>
            <el-col :span="8">  
                <alloce-menu ref="menus" v-if="show" :roleList="roleList" :row_data="row_data" :menuList="menuList" :menuIds="menuIds"/>
